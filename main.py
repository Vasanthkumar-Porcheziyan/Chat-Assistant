...
def user_message(message):
    st.markdown(f'<div class="user-message" style="display: flex; justify-content: flex-end; align-items: center; width: 100%; padding: 5px; gap: 8px;">'
...
def bot_message(message):
    st.markdown(f'<div class="bot-message" style="display: flex; align-items: center; width: 100%; padding: 5px; gap: 8px;">'
